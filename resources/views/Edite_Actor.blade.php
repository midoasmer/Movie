...
@section('content')
    ...
    {!! Form::model($actor,['method'=>'PATCH','action'=>['App\Http\Controllers\ActorController@update',$actor->id],'files'=>true]) !!}
    @csrf
...
{{--        {!! Form::text('gender',null,['class'=>'form-control']) !!}--}}
    ...
    <div class="image-container">
        <img height="200" src="{{$actor->photo ? $actor->photo->file :'http://placehold.it/50x50'}}">
    </div>
    <br>
